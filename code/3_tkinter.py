...
def main():
    ...
    # def clicked():
    #     print("clicked")
    # btnU = Button(root, text="U", font=("Arial Bold", 50),bg="black", fg="yellow",command=clicked)
    # btnL = Button(root, text="L", font=("Arial Bold", 50),bg="black", fg="yellow",command=clicked)
    # btnR = Button(root, text="R", font=("Arial Bold", 50),bg="black", fg="yellow",command=clicked)
    # btnD = Button(root, text="D", font=("Arial Bold", 50),bg="black", fg="yellow",command=clicked)

    # btnU.pack(side='top',expand='no')#,fill='x')
    # btnD.pack(side='bottom',expand='no')#,fill='x')
    # btnL.pack(side='left',expand='no')#,fill='y')
    # btnR.pack(side='right',expand='no')#,fill='y')
